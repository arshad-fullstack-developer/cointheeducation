...
const form = useForm({
    student_id: props.stationaryAward.student_id,
    school_id: props.stationaryAward.school_id,
    stationary_item_id: props.stationaryAward.stationary_item_id,
    godown_id: props.stationaryAward.godown_id,
    quantity: props.stationaryAward.quantity,
    unit_cost: props.stationaryAward.unit_cost,
    total_cost: props.stationaryAward.total_cost,
    award_type: props.stationaryAward.award_type,
    awarded_by: props.stationaryAward.awarded_by,
    award_date: props.stationaryAward.award_date,
    status: props.stationaryAward.status,
    notes: props.stationaryAward.notes || '',
    return_date: props.stationaryAward.return_date || '',
    return_notes: props.stationaryAward.return_notes || '',
});
...
const submit = () => {
    form.put(route('stationary-awards.update', props.stationaryAward.id));
};
</script>

<template>
    <Head title="Edit Stationary Award" />
            ...
            <div class="max-w-6xl mx-auto space-y-8">
                ...
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 p-8 text-white shadow-2xl">
                    ...
                    <div class="relative z-10 flex justify-between items-center">
                        <div>
                            <h1 class="text-4xl font-bold mb-2">🏆 Edit Award</h1>
                            <p class="text-purple-100 text-lg">Update stationary award details</p>
                        </div>
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-8">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="bg-gradient-to-r from-orange-50 to-amber-50 rounded-3xl p-6 border border-orange-100">
                            <h3 class="text-xl font-bold text-gray-800 mb-4">Status & Return Information</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div v-if="form.status === 'returned'">
                                    <InputLabel for="return_notes" value="Return Notes" />
                                    <textarea
                                        id="return_notes"
                                    ...
                                    ></textarea>
                                    <InputError :message="form.errors.return_notes" />
                                </div>
                            </div>
                        </div>

                        <!-- Pricing -->
                        <div class="bg-gradient-to-r from-emerald-50 to-green-50 rounded-3xl p-6 border border-emerald-100">
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t-2 border-gray-200">
                            ...
                            <PrimaryButton :disabled="form.processing" class="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-pink-600 shadow-lg">
                                {{ form.processing ? 'Updating...' : 'Update Award' }}
                            </PrimaryButton>
                        </div>
                    </form>
                </div>

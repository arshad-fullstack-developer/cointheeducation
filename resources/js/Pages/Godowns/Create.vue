            ...
            <div class="max-w-4xl mx-auto space-y-4">
                ...
                <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 p-4 text-white shadow-2xl">
                    ...
                    <div class="relative z-10">
                        <h1 class="text-3xl font-bold mb-1">🏢 Create New Godown</h1>
                        <p class="text-purple-100 text-base">Add a new warehouse location to your inventory system</p>
                    </div>
                    <!-- Decorative elements -->
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex justify-end space-x-4 pt-6">
                            ...
                            >
                                ...
                                {{ form.processing ? 'Creating...' : 'Create Godown' }}
                            </PrimaryButton>
                        </div>
                    </form>
                </div>

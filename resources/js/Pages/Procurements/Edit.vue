...
const form = useForm({
    stationary_item_id: props.procurement.stationary_item_id,
    godown_id: props.procurement.godown_id,
    quantity: props.procurement.quantity,
    unit_cost: props.procurement.unit_cost,
    total_cost: props.procurement.total_cost,
    company: props.procurement.company,
    salesperson: props.procurement.salesperson,
    payment_type: props.procurement.payment_type,
    procurement_date: props.procurement.procurement_date,
    invoice_number: props.procurement.invoice_number || '',
    notes: props.procurement.notes || '',
...
const submit = () => {
    form.put(route('procurements.update', props.procurement.id));
};
</script>
            ...
            <div class="max-w-4xl mx-auto space-y-4">
                ...
                <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 p-4 text-white shadow-2xl">
                    ...
                    <div class="relative z-10 flex justify-between items-center">
                        <div>
                            <h1 class="text-3xl font-bold mb-1">📦 Edit Procurement</h1>
                            <p class="text-purple-100 text-base">Update procurement #{{ procurement.id }}</p>
                        </div>
                        <a :href="route('procurements.show', procurement.id)" class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl text-white font-semibold hover:bg-white/30 transition-all duration-300">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex justify-end space-x-4">
                            <a :href="route('procurements.show', procurement.id)" class="px-6 py-2 text-sm font-semibold text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
                                Cancel
                            </a>
                            <button
                                type="submit"
                            ...
                            >
                                ...
                                <span v-else>Update Procurement</span>
                            </button>
                        </div>
                    </form>
                </div>

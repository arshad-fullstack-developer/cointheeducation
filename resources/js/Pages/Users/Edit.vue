...
const form = useForm({
  ...
  permission_type: props.user.custom_permissions && props.user.custom_permissions.length > 0 ? 'custom' : 'role',
  custom_permissions: props.user.custom_permissions || []
});
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 p-4 text-white shadow-2xl">
          ...
          <div class="relative z-10 flex justify-between items-center">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h1 class="text-3xl font-bold mb-1">✏️ Edit User</h1>
                <p class="text-purple-100 text-base">Update user information and role</p>
              </div>
            </div>
          </div>
          <!-- Decorative elements -->

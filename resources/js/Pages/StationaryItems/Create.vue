...
const submit = () => {
    form.post(route('stationary-items.store'), {
        onSuccess: () => {
            form.reset();
        },
    });
...
<template>
    <Head title="Create Stationary Item" />
            ...
            <div class="max-w-4xl mx-auto space-y-4">
                ...
                <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 p-4 text-white shadow-xl">
                    ...
                    <div class="relative z-10">
                        <h1 class="text-2xl md:text-3xl font-bold mb-1">📝 Create New Item</h1>
                        <p class="text-purple-100 text-sm md:text-base">Add a new stationary item to your inventory</p>
                    </div>
                    <!-- Decorative elements -->
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-4 md:p-6">
                    <form @submit.prevent="submit" class="space-y-4 md:space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        type="text"
                                        class="mt-2 w-full border-2 border-gray-200 rounded-2xl focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300"
                                        placeholder="Enter article number"
                                    />
                                    <InputError :message="form.errors.article" class="mt-2" />
                                </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                                ...
                                <div>
                                    ...
                                    />
                                    <InputError :message="form.errors.volume" class="mt-2" />
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    <InputError :message="form.errors.shape" class="mt-2" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        step="0.01"
                                        min="0"
                                        class="mt-2 w-full border-2 border-gray-200 rounded-2xl focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300 bg-gray-50"
                                        placeholder="Auto-calculated"
                                        readonly
                                    />
                                    <InputError :message="form.errors.profit_margin" class="mt-2" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                                ...
                                <div>
                                    ...
                                    />
                                    <InputError :message="form.errors.cte_reck_number" class="mt-2" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <select
                                        id="status"
                                        v-model="form.status"
                                        class="mt-2 w-full border-2 border-gray-200 rounded-2xl focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300 bg-white"
                                        required
                                    >
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    class="mt-2 w-full border-2 border-gray-200 rounded-2xl focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300 resize-none"
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            <SecondaryButton
                                type="button"
                                @click="$inertia.visit(route('stationary-items.index'))"
                                class="px-8 py-3 rounded-2xl font-semibold transition-all duration-300"
                            >
                                Cancel
                            </SecondaryButton>
                            <PrimaryButton
                                :disabled="form.processing"
                                class="px-8 py-3 rounded-2xl font-semibold bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-lg hover:shadow-xl"
                            >
